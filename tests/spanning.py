...
app.set_grid(3, 4)
app.add(buttons_container, 1, 5, column_span=2, fill=True, stretch=True)
app.add(button1, 1, 3, column_span=2, fill=True, stretch=True)
app.add(button2, 2, 1, row_span=2, fill=True, stretch=True)
app.add(button3, 3, 4, fill=True, stretch=True)
app.add(labels_container, 2, 4, fill=True, stretch=True)
